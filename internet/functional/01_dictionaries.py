...
j = {
  "cfxinpath": "cfx/inbound/pbm/mm/agadia",
  "sort": "n",
  "csvPath": "files/scripts/config/FlatFileGlueConfig.csv",
  "intermediatePath": "intermediate/pbm/mm/agadia",
  "file_date_format": "%m%d%Y"
}


cfxinpath_value = j.get("cfxinpath")
print(cfxinpath_value)
